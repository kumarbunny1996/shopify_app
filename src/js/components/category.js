...
const mobileCategory = () => {
    let mobileBanner = banner({
        ...
        img: "/images/mobilesStore/Mobile-Phone-PNG-Transparent-HD-Photo-min.png"
    });
...
const speakerCategory = () => {
    let speakerBanner = banner({
        ...
        img: "/images/speakers/Bluetooth-Headset-PNG-Background-Image-min.png"
    });
...
const laptopCategory = () => {
    let laptopBanner = banner({
        ...
        img: "/images/laptopStore/pngkey.com-macbook-air-png-1844127-min.png"
    });
...
const homeCategory = () => {
    let homeBanner = banner({
        ...
        img: "/images/homeStore/Home-Appliance-PNG-Pic-min.png"
    });
...
const electronicsCategory = () => {
    let electronicsBanner = banner({
        ...
        img: "/images/electronics/pngkey.com-table-fan-png-351479-min.png"
    });
...
const womenCategory = () => {
    let womenBanner = banner({
        ...
        img: "/images/womens/Floral-Dress-PNG-HD-min.png"
    });
...
const menCategory = () => {
    let menBanner = banner({
        ...
        img: "/images/mens/pngkey.com-breaking-bad-png-9530014-min.png"
    });
...
const allCategories = () => {
    let allBanner = banner({
        ...
        img: "/images/commonStore/amazon-dhamaka-1.png"
    });

    let mobileSec = categoryDom({
        class: "mobile-section",
        img: "/images/mobilesStore/IPhone-Apple-PNG-File.png",
        title: "Mobiles",
        value: "#mobiles"
    });
    ...
    let speakerSec = categoryDom({
        ...
        img: "/images/speakers/Red-Bluetooth-Speaker-Transparent-PNG-min.png",
        title: "Speakers",
        value: "#speakers"
    });
    let laptopSec = categoryDom({
        class: "laptop-section",
        img: "/images/laptopStore/laptop-hd-png-laptop-png-free-download-485-min.png",
        title: "Laptops",
        value: "#laptops"
    });
    let electronicsSec = categoryDom({
        class: "electronics-section",
        img: "/images/electronics/pngkey.com-camera-png-80856-min.png",
        title: "Electronics",
        value: "#electronics"
    });
    let homeSec = categoryDom({
        class: "home-section",
        img: "/images/homeStore/pngkey.com-cricket-clipart-png-2494895-min.png",
        title: "Home-appliances",
        value: "#home-appliances"
    });
    let womenSec = categoryDom({
        class: "women-section",
        img: "/images/womens/pngkey.com-female-model-png-986952-min.png",
        title: "Women",
        value: "#women"
    })
    let menSec = categoryDom({
        class: "men-section",
        img: "/images/mens/Maroon-T-Shirt-PNG-min.png",
        title: "Men",
        value: "#men",
    });
